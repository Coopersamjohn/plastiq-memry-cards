...
public class FlashcardSetClient extends FlashcardSetServiceGrpc.FlashcardSetServiceImplBase {
    ...
    public FlashcardSet getFlashcardSetById(UUID flashcardSetId) {
        ...
        StreamObserver<GetFlashcardSetByIdRequest> responseObserver = new StreamObserver<GetFlashcardSetByIdRequest>() {

            @Override
            public void onNext(GetFlashcardSetByIdRequest getFlashcardSetByIdRequest) {
        ...
        try {
            ...
            asyncStub.getFlashcardSetById(responseObserver);
